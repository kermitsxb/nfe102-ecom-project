...
class PaymentMethodTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PaymentMethodTableMap';
     ...
     */
    const CLASS_DEFAULT = 'PaymentMethod';
     ...
     */
    const COL_LABEL = 'payment_method.label';

    /**
     * the column name for the status field
     */
    const COL_STATUS = 'payment_method.status';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PaymentMethodTableMap::COL_ID, PaymentMethodTableMap::COL_LABEL, PaymentMethodTableMap::COL_STATUS, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PaymentMethodTableMap::COL_ID => 0, PaymentMethodTableMap::COL_LABEL => 1, PaymentMethodTableMap::COL_STATUS => 2, ),
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PaymentMethodTableMap::COL_LABEL);
            $criteria->addSelectColumn(PaymentMethodTableMap::COL_STATUS);
        } else {
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                PaymentMethodTableMap::removeInstanceFromPool($singleval);
            }
        }
