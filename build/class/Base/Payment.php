...
abstract class Payment implements ActiveRecordInterface
{
    ...
    public function setPaymentMethodId($v)
    {
        ...
        if ($this->payment_method_id !== $v) {
            ...
            $this->modifiedColumns[PaymentTableMap::COL_PAYMENT_METHOD_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PaymentTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PaymentTableMap::translateFieldName('PaymentMethodId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PaymentTableMap::COL_PAYMENT_METHOD_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getPaymentMethodId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setPaymentMethodId($arr[$keys[3]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaymentTableMap::COL_PAYMENT_METHOD_ID)) {
            $criteria->add(PaymentTableMap::COL_PAYMENT_METHOD_ID, $this->payment_method_id);
        }
    ...
    public function hashCode()
    {
        ...
        //relation fk_payment_payment_method1 to table payment_method
        if ($this->aPaymentMethod && $hash = spl_object_hash($this->aPaymentMethod)) {
            $primaryKeyFKs[] = $hash;
        } else {
    ...
    {
        return (null === $this->getId()) && (null === $this->getPaymentMethodId());
    }
     ...
     * @return ObjectCollection|ChildOrder[] List of ChildOrder objects
     */
    public function getOrdersJoinShipment(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrderQuery::create(null, $criteria);
        $query->joinWith('Shipment', $joinBehavior);
    ...
    {
        if (null !== $this->aPaymentMethod) {
            $this->aPaymentMethod->removePayment($this);
        }
        $this->id = null;
        $this->status = null;
        $this->amount = null;
