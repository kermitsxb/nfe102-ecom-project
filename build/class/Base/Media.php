...
abstract class Media implements ActiveRecordInterface
{
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[MediaTableMap::COL_LABEL] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[MediaTableMap::COL_PRODUCT_ID] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[MediaTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MediaTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MediaTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
            $this->url = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MediaTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MediaTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = MediaTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MediaTableMap::COL_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'label';
        }
        if ($this->isColumnModified(MediaTableMap::COL_URL)) {
            $modifiedColumns[':p' . $index++]  = 'url';
        }
        if ($this->isColumnModified(MediaTableMap::COL_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'product_id';
        }
        if ($this->isColumnModified(MediaTableMap::COL_STATUS)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MediaTableMap::COL_LABEL)) {
            $criteria->add(MediaTableMap::COL_LABEL, $this->label);
        }
        if ($this->isColumnModified(MediaTableMap::COL_URL)) {
            $criteria->add(MediaTableMap::COL_URL, $this->url);
        }
        if ($this->isColumnModified(MediaTableMap::COL_PRODUCT_ID)) {
            $criteria->add(MediaTableMap::COL_PRODUCT_ID, $this->product_id);
        }
        if ($this->isColumnModified(MediaTableMap::COL_STATUS)) {
            $criteria->add(MediaTableMap::COL_STATUS, $this->status);
        }
    ...
    public function hashCode()
    {
        ...
        //relation fk_media_product1 to table product
    ...
    {
        return (null === $this->getId()) && (null === $this->getProductId());
    }
    ...
    {
        if (null !== $this->aProduct) {
            $this->aProduct->removeMedia($this);
        }
        $this->id = null;
        $this->label = null;
        $this->url = null;
