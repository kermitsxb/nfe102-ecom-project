...
abstract class PaymentMethod implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PaymentMethodTableMap';
    ...
    /**
     * Initializes internal state of Base\PaymentMethod object.
     */
     ...
     *
     * @return $this|PaymentMethod The current object, for fluid interface
     */
     ...
     * @return $this|\PaymentMethod The current object (for fluent API support)
     */
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[PaymentMethodTableMap::COL_LABEL] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[PaymentMethodTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PaymentMethodTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PaymentMethodTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = PaymentMethodTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PaymentMethod'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PaymentMethodTableMap::COL_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'label';
        }
        if ($this->isColumnModified(PaymentMethodTableMap::COL_STATUS)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PaymentMethod'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PaymentMethod'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaymentMethodTableMap::COL_LABEL)) {
            $criteria->add(PaymentMethodTableMap::COL_LABEL, $this->label);
        }
        if ($this->isColumnModified(PaymentMethodTableMap::COL_STATUS)) {
            $criteria->add(PaymentMethodTableMap::COL_STATUS, $this->status);
        }
    ...
    {
        $criteria = ChildPaymentMethodQuery::create();
        $criteria->add(PaymentMethodTableMap::COL_ID, $this->id);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPaymentMethod The current object (for fluent API support)
     */
    public function setPayments(Collection $payments, ConnectionInterface $con = null)
    {
        ...
        foreach ($paymentsToDelete as $paymentRemoved) {
            $paymentRemoved->setPaymentMethod(null);
        }
