...
abstract class Currency implements ActiveRecordInterface
{
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[CurrencyTableMap::COL_LABEL] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CurrencyTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CurrencyTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CurrencyTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CurrencyTableMap::COL_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'label';
        }
        if ($this->isColumnModified(CurrencyTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(CurrencyTableMap::COL_STATUS)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CurrencyTableMap::COL_LABEL)) {
            $criteria->add(CurrencyTableMap::COL_LABEL, $this->label);
        }
        if ($this->isColumnModified(CurrencyTableMap::COL_CODE)) {
            $criteria->add(CurrencyTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(CurrencyTableMap::COL_STATUS)) {
            $criteria->add(CurrencyTableMap::COL_STATUS, $this->status);
        }
     ...
     * @return ObjectCollection|ChildProductPrice[] List of ChildProductPrice objects
     */
    public function getProductPricesJoinProduct(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductPriceQuery::create(null, $criteria);
