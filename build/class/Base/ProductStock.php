...
abstract class ProductStock implements ActiveRecordInterface
{
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[ProductStockTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductStockTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductStockTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ProductStockTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductStockTableMap::COL_VALUE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductStockTableMap::COL_VALUE)) {
            $criteria->add(ProductStockTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(ProductStockTableMap::COL_PRODUCT_ID)) {
    ...
    public function hashCode()
    {
        ...
        //relation fk_product_stock_product1 to table product
    ...
    public function getProduct(ConnectionInterface $con = null)
    {
        if ($this->aProduct === null && ($this->product_id !== null)) {
            $this->aProduct = ChildProductQuery::create()
                ->filterByProductStock($this) // here
                ->findOne($con);
