...
/**
 * Base class that represents a row from the 'product_shelf' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ProductShelf implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ProductShelfTableMap';
    ...
    /**
     * Initializes internal state of Base\ProductShelf object.
     */
    ...
    /**
     * Compares this with another <code>ProductShelf</code> instance.  If
     * <code>obj</code> is an instance of <code>ProductShelf</code>, delegates to
     * <code>equals(ProductShelf)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ProductShelf The current object, for fluid interface
     */
     ...
     * @return $this|\ProductShelf The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProductShelfTableMap::COL_ID] = true;
        }
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[ProductShelfTableMap::COL_LABEL] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[ProductShelfTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductShelfTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductShelfTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductShelfTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ProductShelfTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ProductShelf'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProductShelfQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProductShelf::setDeleted()
     * @see ProductShelf::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProductShelfQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductShelfTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductShelfTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ProductShelfTableMap::COL_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'label';
        }
        if ($this->isColumnModified(ProductShelfTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }

        $sql = sprintf(
            'INSERT INTO product_shelf (%s) VALUES (%s)',
    ...
    {
        $pos = ProductShelfTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ProductShelf'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductShelf'][$this->hashCode()] = true;
        $keys = ProductShelfTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductShelfTableMap::COL_ID)) {
            $criteria->add(ProductShelfTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ProductShelfTableMap::COL_LABEL)) {
            $criteria->add(ProductShelfTableMap::COL_LABEL, $this->label);
        }
        if ($this->isColumnModified(ProductShelfTableMap::COL_STATUS)) {
            $criteria->add(ProductShelfTableMap::COL_STATUS, $this->status);
        }
    ...
    {
        $criteria = ChildProductShelfQuery::create();
        $criteria->add(ProductShelfTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ProductShelf (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ProductShelf Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildProductShelf is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildProductShelf The current object (for fluent API support)
     */
    public function setProducts(Collection $products, ConnectionInterface $con = null)
    {
        ...
        $this->productsScheduledForDeletion = clone $productsToDelete;

        foreach ($productsToDelete as $productRemoved) {
            $productRemoved->setProductShelf(null);
        }
    ...
    {
        return (string) $this->exportTo(ProductShelfTableMap::DEFAULT_STRING_FORMAT);
    }
