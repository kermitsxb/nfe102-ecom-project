...
abstract class Shipment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ShipmentTableMap';
    ...
    /**
     * The value for the amount_ht field.
     *
     * @var        string
     */
    protected $amount_ht;
    ...
    /**
     * The value for the amount_ttc field.
     *
     * @var        string
     */
    protected $amount_ttc;
    ...
    /**
     * Initializes internal state of Base\Shipment object.
     */
    ...
    /**
     * Get the [amount_ht] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [amount_ttc] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Shipment The current object (for fluent API support)
     */
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_STATUS] = true;
        }
    ...
    /**
     * Set the value of [amount_ht] column.
     *
     * @param string $v new value
     * @return $this|\Shipment The current object (for fluent API support)
     */
    public function setAmountHt($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->amount_ht !== $v) {
            $this->amount_ht = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_AMOUNT_HT] = true;
        }
    ...
    /**
     * Set the value of [amount_ttc] column.
     *
     * @param string $v new value
     * @return $this|\Shipment The current object (for fluent API support)
     */
    public function setAmountTtc($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->amount_ttc !== $v) {
            $this->amount_ttc = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_AMOUNT_TTC] = true;
        }
    ...
    public function setShipmentMethodId($v)
    {
        ...
        if ($this->shipment_method_id !== $v) {
            ...
            $this->modifiedColumns[ShipmentTableMap::COL_SHIPMENT_METHOD_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ShipmentTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ShipmentTableMap::translateFieldName('AmountHt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount_ht = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ShipmentTableMap::translateFieldName('AmountTtc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount_ttc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ShipmentTableMap::translateFieldName('ShipmentMethodId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = ShipmentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Shipment'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ShipmentTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_AMOUNT_HT)) {
            $modifiedColumns[':p' . $index++]  = 'amount_ht';
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_AMOUNT_TTC)) {
            $modifiedColumns[':p' . $index++]  = 'amount_ttc';
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_SHIPMENT_METHOD_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'status':
                        ...
                        break;
                    case 'amount_ht':
                        $stmt->bindValue($identifier, $this->amount_ht, PDO::PARAM_STR);
                        break;
                    case 'amount_ttc':
                        $stmt->bindValue($identifier, $this->amount_ttc, PDO::PARAM_STR);
                        break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getAmountHt(),
            $keys[3] => $this->getAmountTtc(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setAmountHt($value);
                break;
            case 3:
                $this->setAmountTtc($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setAmountHt($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setAmountTtc($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ShipmentTableMap::COL_STATUS)) {
            $criteria->add(ShipmentTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_AMOUNT_HT)) {
            $criteria->add(ShipmentTableMap::COL_AMOUNT_HT, $this->amount_ht);
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_AMOUNT_TTC)) {
            $criteria->add(ShipmentTableMap::COL_AMOUNT_TTC, $this->amount_ttc);
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_SHIPMENT_METHOD_ID)) {
            $criteria->add(ShipmentTableMap::COL_SHIPMENT_METHOD_ID, $this->shipment_method_id);
        }
    ...
    public function hashCode()
    {
        ...
        //relation fk_shipment_shipment_method1 to table shipment_method
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAmountHt($this->getAmountHt());
        $copyObj->setAmountTtc($this->getAmountTtc());
    ...
    public function getShipmentMethod(ConnectionInterface $con = null)
    {
        if ($this->aShipmentMethod === null && ($this->shipment_method_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aShipmentMethod->addShipments($this);
             */
        }
    ...
    {
        if (null !== $this->aShipmentMethod) {
            $this->aShipmentMethod->removeShipment($this);
        }
        $this->id = null;
        $this->status = null;
        $this->amount_ht = null;
        $this->amount_ttc = null;
